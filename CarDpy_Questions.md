...
made them both match --> we should make note in the readme 
...
--> changed Diffusivity.py:31 to "if dif in bval_low_indicies:" rather than "if dif == bval_low_indicies:"
---
